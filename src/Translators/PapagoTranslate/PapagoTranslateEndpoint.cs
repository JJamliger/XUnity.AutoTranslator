...
namespace PapagoTranslate
{
    public class PapagoTranslateEndpoint : HttpEndpoint
    {
        ...
        private static readonly Regex PatternVersion = new Regex(@"AUTH_KEY:""([^""]*)""", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        private IEnumerator SetupVersion()
        {
            ...
            // parse version from javascript file
            {
                ...
                XuaLogger.AutoTranslator.Debug($"Current papago version is {_version}");
            }
        }
    }
}
